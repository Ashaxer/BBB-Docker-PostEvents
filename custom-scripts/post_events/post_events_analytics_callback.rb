...
require File.expand_path('/usr/local/bigbluebutton/core/lib/recordandplayback.rb', __FILE__)
...
props = YAML.safe_load(File.open('/usr/local/bigbluebutton/core/scripts/bigbluebutton.yml'))
...
puts "DEBUG: Loaded events_dir as: #{events_dir}"
puts "DEBUG: Constructed path: #{meeting_events_dir}/events.xml"
puts "DEBUG: File exists check: #{File.exist?("#{meeting_events_dir}/events.xml")}"
# -------------------------------------
